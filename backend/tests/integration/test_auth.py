...
async def test_register_weak_password_returns_422(client) -> None:
    payload = {**REGISTER_PAYLOAD, "email": "weak@onconexus.test", "password": "short"}
...
async def test_refresh_rotates_tokens(client) -> None:
    ...
    # The old refresh token must now be rejected (rotation/replay protection).
